...
1.STRUCTURE
 ...
 1.2 FRONTEND
      1.2.1 USER INTERFACE
         The User interface has a menu on top with three voices that address to three visualization pages those still contain the menu choice on top, but the content is totally different: 
